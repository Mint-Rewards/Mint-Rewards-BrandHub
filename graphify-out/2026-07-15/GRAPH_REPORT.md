...
## Corpus Check
- 138 files · ~802,017 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1116 nodes · 1725 edges · 162 communities (75 shown, 87 thin omitted)
...
Cohesion: 0.09
Nodes (25): InsufficientPermissionError, ModuleNotSubscribedError, CampaignsTab(), STATUS_CONFIG, CreateCampaignForm(), getContrastingTextColor(), DealsTab(), AlertDialogAction (+17 more)

### Community 1 - "Brand API Actions & Analytics Types"
Cohesion: 0.08
Nodes (31): CreateCampaignFormProps, PromotionsTabProps, BrandApplication, BrandStatus, BrandTheme, BrandThemeDocument, Campaign, CampaignAddress (+23 more)
...
Cohesion: 0.08
Nodes (21): CAMPAIGN_STATUS_STYLES, CO2_SAVINGS_PER_KG, EQUIVALENT_CONVERSIONS, formatKg(), hex(), MATERIAL_COLORS, OverviewTab(), ChartConfig (+13 more)
...
Cohesion: 0.08
Nodes (46): BrandAnalytics, BrandNotFoundError, CampaignSummary, createCampaign(), createDeal(), createOrgBrand(), deleteCampaign(), deleteDeal() (+38 more)
...
Cohesion: 0.05
Nodes (80): App(), queryClient, AdminProtectedRoute(), CampaignFormData, campaignSchema, CreateDealForm(), CreateDealFormProps, DealFormData (+72 more)

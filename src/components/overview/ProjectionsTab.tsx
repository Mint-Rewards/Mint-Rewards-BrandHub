    ...
    stats: [
      {
        ...
        containerClassName: "p-3 bg-gradient-to-br from-green-50 to-emerald-50",
      ...
      },
      {
        ...
        containerClassName: "p-3 bg-gradient-to-br from-blue-50 to-cyan-50",
      ...
      },
      {
        ...
        containerClassName: "p-3 bg-gradient-to-br from-purple-50 to-pink-50",
  ...
  },
  {
    ...
    stats: [
      ...
      },
      {
        ...
        containerClassName: "p-3 bg-gradient-to-br from-orange-50 to-red-50",
  ...
  },
  {
    ...
    stats: [
      ...
      },
      {
        ...
        caption: "Annual goal",
        containerClassName: "p-3 bg-gradient-to-br from-indigo-50 to-purple-50",
      ...
      },
      {
        ...
        containerClassName: "p-3 bg-gradient-to-br from-teal-50 to-cyan-50",
...
const KPI_PROJECTIONS = [
  {
    ...
    containerClassName: "bg-gradient-to-r from-green-50 to-emerald-50",
  },
  {
    ...
    containerClassName: "bg-gradient-to-r from-blue-50 to-cyan-50",
  },
  {
    ...
    containerClassName: "bg-gradient-to-r from-purple-50 to-pink-50",
  },
];
